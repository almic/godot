...
void VehicleDifferentialSettings::_bind_methods()
{
	...
	ClassDB::bind_method(D_METHOD("is_open_differential"), &VehicleDifferentialSettings::is_open_differential);
	ClassDB::bind_method(D_METHOD("set_open_differential", "is_open"), &VehicleDifferentialSettings::set_open_differential);
	...
	ADD_PROPERTY(PropertyInfo(Variant::BOOL, "open"), "set_open_differential", "is_open_differential");
...
{
	if (is_open_differential() && p_property.name == "slip_ratio")
	{
